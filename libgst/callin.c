...
OOP _gst_va_msg_send(OOP receiver, OOP selector, va_list ap) {
  va_list save;
  OOP *args, anArg;
  int numArgs;
...
/* Use like printf */
void _gst_va_msg_sendf(PTR resultPtr, const char *fmt, va_list ap) {
  ...
  *s = '\0';
  ...
  for (i = -1, fp = &fmt[2]; *fp; fp++) {
    ...
    case 'C':
      args[++i] =
          COBJECT_NEW(va_arg(ap, PTR), _gst_nil_oop, _gst_c_object_class);
      INC_ADD_OOP(args[i]);
      break;
  ...
  if (resultPtr) {
    ...
    case 'c':
      *(char *)resultPtr = IS_NIL(result) ? 0 : CHAR_OOP_VALUE(result);
      break;

    case 'C':
      *(PTR *)resultPtr = IS_NIL(result) ? NULL : cobject_value(result);
      break;

    case 's':
      *(char **)resultPtr = IS_NIL(result) ? NULL : _gst_to_cstring(result);
      break;

    case 'b':
      *(int *)resultPtr = IS_NIL(result) ? false : (result == _gst_true_oop);
      break;

    case 'f':
      *(double *)resultPtr = IS_NIL(result) ? 0.0 : _gst_oop_to_float(result);
      break;
    ...
    case 'w':
      *(wchar_t *)resultPtr = IS_NIL(result) ? 0 : CHAR_OOP_VALUE(result);
      break;
...
OOP _gst_type_name_to_oop(const char *name) {
  OOP result;
  char buf[300];
...
void _gst_eval_code(const char *str) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_eval_expr(const char *str) {
  OOP result;
...
OOP _gst_object_alloc(OOP class_oop, int size) {
  OOP oop;
...
int _gst_basic_size(OOP oop) { return (NUM_INDEXABLE_FIELDS(oop)); }
...
OOP _gst_class_name_to_oop(const char *name) {
  OOP result, key;
  char *s, *p, *prev_p;
...
OOP _gst_uint_to_oop(unsigned long int i) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_int_to_oop(long int i) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_long_double_to_oop(long double f) {
  return (INC_ADD_OOP(floatq_new(f)));
}

OOP _gst_float_to_oop(double f) { return (INC_ADD_OOP(floatd_new(f))); }

OOP _gst_bool_to_oop(int b) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_wchar_to_oop(wchar_t wc) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_wstring_to_oop(const wchar_t *str) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_byte_array_to_oop(const char *str, int n) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_symbol_to_oop(const char *str) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_c_object_to_oop(PTR co) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
void _gst_set_c_object(OOP oop, PTR co) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
long double _gst_oop_to_long_double(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
wchar_t _gst_oop_to_wchar(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
wchar_t *_gst_oop_to_wstring(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
char *_gst_oop_to_byte_array(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
PTR _gst_oop_to_c_object(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_get_object_class(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_get_superclass(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
bool _gst_class_is_kind_of(OOP candidate, OOP superclass) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
bool _gst_object_is_kind_of(OOP candidate, OOP superclass) {
  OOP its_class;
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_perform(OOP receiver, OOP selector) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_perform_with(OOP receiver, OOP selector, OOP arg) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
bool _gst_class_implements_selector(OOP classOOP, OOP selector) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
bool _gst_class_can_understand(OOP classOOP, OOP selector) {
...
bool _gst_responds_to(OOP oop, OOP selector) {
  method_cache_entry dummy;
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_oop_at(OOP oop, size_t index) {
  OOP result;
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
OOP _gst_oop_at_put(OOP oop, size_t index, OOP new) {
  OOP old;
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
void *_gst_oop_indexed_base(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
enum gst_indexed_kind _gst_oop_indexed_kind(OOP oop) {
  if (!_gst_smalltalk_initialized) {
    _gst_initialize(NULL, NULL, GST_NO_TTY);
  }
...
void _gst_unregister_oop(OOP oop) {
  ...
  while (entry) {
    ...
    entry = (oop_registry *)(oop < entry->oop ? entry->rb.rb_left
                                              : entry->rb.rb_right);
  }
  pthread_mutex_unlock(&oop_registry_root_mutex);
}

void _gst_register_oop_array(OOP **first, OOP **last) {
...
void _gst_unregister_oop_array(OOP **first) {
  ...
  while (entry) {
    ...
    entry = (oop_array_registry *)(first < entry->first ? entry->rb.rb_left
                                                        : entry->rb.rb_right);
  }
  pthread_mutex_unlock(&oop_registry_root_mutex);
}

void _gst_copy_registered_oops(void) {
  rb_node_t *node;
  rb_traverse_t t;

  pthread_mutex_lock(&oop_registry_root_mutex);
  /* Walk the OOP registry...  */
  for (node = rb_first(&(oop_registry_root->rb), &t); node;
       node = rb_next(&t)) {
  ...
  for (node = rb_first(&(oop_array_registry_root->rb), &t); node;
       node = rb_next(&t)) {
...
void _gst_mark_registered_oops(void) {
  rb_node_t *node;
  rb_traverse_t t;
...
struct VMProxy *_gst_get_vmproxy(void) {
