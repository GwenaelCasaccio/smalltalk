...
#define MATCH_BYTECODES(name_, bp_, code_)                                     \
  BEGIN_MACRO {                                                                \
    int arg, arg_lsb, n, num_args, ofs, opcode, opcode_, scopes, super;        \
    unsigned char *IP = bp_;                                                   \
    unsigned char ATTRIBUTE_UNUSED *IP0 = bp_;                                 \
    arg = arg_lsb = n = num_args = ofs = opcode = opcode_ = scopes = super =   \
        0;                                                                     \
    MATCH_BYTECODES_START_##name_ : opcode_ = *IP;                             \
    MATCH_BYTECODES_SWITCH_##name_ : switch (opcode_) {                        \
    case 0:                                                                    \
      opcode = IP[0];                                                          \
      arg_lsb = IP[1];                                                         \
      bp_ = (IP += 2);                                                         \
...
#define MATCH_BYTECODES_PRINT_BYTECODE_NAME                                    \
  ...
  MATCH_BYTECODES_PRINT_BYTECODE_NAME_SEND : {                                 \
    printf("%s\tsend selector %d%s, %d args", prefix, n,                       \
           super ? " to super" : "", num_args);                                \
    if (literal_vec)                                                           \
      printf(" = %O", literal_vec[n]);                                         \
    printf("\n");                                                              \
    prefix = pref;                                                             \
  ...
  MATCH_BYTECODES_PRINT_BYTECODE_NAME_SEND_IMMEDIATE : {                       \
    printf("%s\tsend special message %O%s\n", prefix,                          \
           _gst_builtin_selectors[n].symbol, super ? " to super" : "");        \
    prefix = pref;                                                             \
  }                                                                            \
  goto MATCH_BYTECODES_SWITCH_PRINT_BYTECODE_NAME;                             \
...
#define MATCH_BYTECODES_IS_SIMPLE_RETURN                                       \
  MATCH_BYTECODES_IS_SIMPLE_RETURN_PUSH_SELF : { maybe = MTH_RETURN_SELF; }    \
  ...
  goto MATCH_BYTECODES_SWITCH_IS_SIMPLE_RETURN;                                \
  MATCH_BYTECODES_IS_SIMPLE_RETURN_INVALID : { abort(); }                      \
  goto MATCH_BYTECODES_SWITCH_IS_SIMPLE_RETURN;
...
#define MATCH_BYTECODES_CHECK_KIND_OF_BLOCK                                    \
  ...
  goto MATCH_BYTECODES_SWITCH_CHECK_KIND_OF_BLOCK;                             \
  MATCH_BYTECODES_CHECK_KIND_OF_BLOCK_INVALID : { abort(); }                   \
  goto MATCH_BYTECODES_SWITCH_CHECK_KIND_OF_BLOCK;
...
#define MATCH_BYTECODES_THREAD_JUMPS                                           \
  ...
  goto MATCH_BYTECODES_SWITCH_THREAD_JUMPS;                                    \
  MATCH_BYTECODES_THREAD_JUMPS_INVALID : { abort(); }                          \
  goto MATCH_BYTECODES_SWITCH_THREAD_JUMPS;
...
#define MATCH_BYTECODES_COMPUTE_STACK_POS                                      \
  ...
  MATCH_BYTECODES_COMPUTE_STACK_POS_POP_STACK_TOP : { balance--; }             \
  goto MATCH_BYTECODES_SWITCH_COMPUTE_STACK_POS;                               \
  ...
  MATCH_BYTECODES_COMPUTE_STACK_POS_PUSH_OUTER_TEMP : { balance++; }           \
  goto MATCH_BYTECODES_SWITCH_COMPUTE_STACK_POS;                               \
  ...
  goto MATCH_BYTECODES_SWITCH_COMPUTE_STACK_POS;                               \
  MATCH_BYTECODES_COMPUTE_STACK_POS_SEND : { balance -= super + num_args; }    \
  goto MATCH_BYTECODES_SWITCH_COMPUTE_STACK_POS;                               \
  ...
  goto MATCH_BYTECODES_SWITCH_COMPUTE_STACK_POS;                               \
  MATCH_BYTECODES_COMPUTE_STACK_POS_INVALID : { abort(); }                     \
  goto MATCH_BYTECODES_SWITCH_COMPUTE_STACK_POS;                               \
  MATCH_BYTECODES_COMPUTE_STACK_POS_JUMP : {                                   \
    ...
    /* We cannot fill the basic block right now because the                    \
       stack height might be different.  */                                    \
    if (!bb_start[bc_len]) {                                                   \
      ALLOCA_BASIC_BLOCK(bb_start + bc_len, 0, bp_first + bc_len, 0);          \
      bb_start[bc_len]->suspended = true;                                      \
      bb_start[bc_len]->next = NULL;                                           \
      *susp_tail = bb_start[bc_len];                                           \
      susp_tail = &(bb_start[bc_len]->next);                                   \
...
#define MATCH_BYTECODES_MAKE_DEST_TABLE                                        \
  ...
  MATCH_BYTECODES_MAKE_DEST_TABLE_INVALID : { abort(); }                       \
  goto MATCH_BYTECODES_SWITCH_MAKE_DEST_TABLE;                                 \
...
#define MATCH_BYTECODES_CREATE_BASIC_BLOCKS                                    \
  ...
  MATCH_BYTECODES_CREATE_BASIC_BLOCKS_RETURN_CONTEXT_STACK_TOP : {             \
    ...
    /* We cannot fill the basic block right now because the                    \
       stack height might be different.  */                                    \
    if (!bb_start[bc_len]) {                                                   \
      ALLOCA_BASIC_BLOCK(bb_start + bc_len, stack_depth, bp_first + bc_len,    \
                         curr_sp + balance);                                   \
      bb_start[bc_len]->suspended = true;                                      \
      bb_start[bc_len]->next = NULL;                                           \
      *susp_tail = bb_start[bc_len];                                           \
  ...
  MATCH_BYTECODES_CREATE_BASIC_BLOCKS_POP_STACK_TOP : { balance--; }           \
  goto MATCH_BYTECODES_SWITCH_CREATE_BASIC_BLOCKS;                             \
  ...
  MATCH_BYTECODES_CREATE_BASIC_BLOCKS_PUSH_OUTER_TEMP : { balance++; }         \
  goto MATCH_BYTECODES_SWITCH_CREATE_BASIC_BLOCKS;                             \
  ...
  goto MATCH_BYTECODES_SWITCH_CREATE_BASIC_BLOCKS;                             \
  MATCH_BYTECODES_CREATE_BASIC_BLOCKS_DUP_STACK_TOP : { balance++; }           \
  goto MATCH_BYTECODES_SWITCH_CREATE_BASIC_BLOCKS;                             \
    ...
    if (!bb_start[bc_len]) {                                                   \
      ...
      *susp_tail = bb_start[bc_len];                                           \
      susp_tail = &(bb_start[bc_len]->next);                                   \
                                                                               ...
                                                                               \
    if (!bb_start[ofs]) {                                                      \
      ALLOCA_BASIC_BLOCK(bb_start + ofs, stack_depth, bp_first + ofs,          \
                         curr_sp + balance);                                   \
                                                                               \
      bb_start[ofs]->next = worklist;                                          \
      worklist = bb_start[ofs];                                                \
...
#define MATCH_BYTECODES_EXEC_BASIC_BLOCK                                       \
  ...
  goto MATCH_BYTECODES_SWITCH_EXEC_BASIC_BLOCK;                                \
  MATCH_BYTECODES_EXEC_BASIC_BLOCK_RETURN_CONTEXT_STACK_TOP : { break; }       \
  goto MATCH_BYTECODES_SWITCH_EXEC_BASIC_BLOCK;                                \
  ...
  goto MATCH_BYTECODES_SWITCH_EXEC_BASIC_BLOCK;                                \
  MATCH_BYTECODES_EXEC_BASIC_BLOCK_INVALID : { abort(); }                      \
  goto MATCH_BYTECODES_SWITCH_EXEC_BASIC_BLOCK;
#endif
