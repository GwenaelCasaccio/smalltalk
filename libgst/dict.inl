...
static inline void nil_fill(OOP *oopPtr, size_t oopCount);
...
static inline gst_object new_instance_with(OOP class_oop, size_t numIndexFields,
                                           OOP *p_oop);
...
static inline gst_object new_instance(OOP class_oop, OOP *p_oop);
...
/* Returns a new, initialized instance of CLASS_OOP within an
   ...
   boundary).  */
static inline gst_object instantiate_numbytes(OOP class_oop, OOP *p_oop,
                                              intptr_t instanceSpec,
                                              size_t numBytes);
...
/* Returns a new, initialized instance of CLASS_OOP with
   ...
   boundary).  */
static inline gst_object instantiate_with(OOP class_oop, size_t numIndexFields,
                                          OOP *p_oop);
...
static inline gst_object instantiate(OOP class_oop, OOP *p_oop);
...
static inline OOP dictionary_association_at(OOP dictionaryOOP, OOP keyOOP);

/* Answer the value associated to KEYOOP in the Dictionary (or a
   subclass having the same representation) DICTIONARYOOP.  */
static inline OOP dictionary_at(OOP dictionaryOOP, OOP keyOOP);

/* Creates a new Association object having the
   specified KEY and VALUE.  */
static inline OOP association_new(OOP key, OOP value);

/* Creates a new VariableBinding object having the
   specified KEY and VALUE.  */
static inline OOP variable_binding_new(OOP key, OOP value, OOP environment);
...
static inline OOP index_oop(OOP oop, size_t index);
...
static inline OOP index_oop_spec(OOP oop, gst_object object, size_t index,
                                 intptr_t instanceSpec);
...
static inline double floatd_oop_value(floatOOP) OOP floatOOP;
{
  gst_object obj;
  double d;
...
static inline long double floatq_oop_value(floatOOP) OOP floatOOP;
{
  gst_object obj;
  long double d;
...
static int num_valid_oops(const OOP oop) {
